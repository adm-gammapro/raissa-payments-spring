...
@Data
@NoArgsConstructor
public class ConfiguracionReglaConnectResponseDto extends SearchResponseDTO {
    List<ConfiguracionReglaResponseDto> list;

    public ConfiguracionReglaConnectResponseDto(int totalPages,
                                   long totalElements,
                                   int pageNumber,
                                   int rowPages,
                                   List<ConfiguracionReglaResponseDto> list) {
